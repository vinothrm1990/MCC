...
public class Constants {
    ...
    public static String BIO_UPLOAD = "bio_upload.php?";
    public static String AUDIO_UPLOAD = "audio_upload.php?";
    public static String VIDEO_UPLOAD = "video_upload.php?";
    public static String PHOTO_UPLOAD = "photo_upload.php?";
